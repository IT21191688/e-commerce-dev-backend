...
ProductRouter.post("/createProduct", auth_middleware_1.default.authorize([constant_1.default.USER.ROLES.ADMIN]), common_middleware_1.default.multerUploader.single("productimage"), product_controller_1.CreateProduct);
